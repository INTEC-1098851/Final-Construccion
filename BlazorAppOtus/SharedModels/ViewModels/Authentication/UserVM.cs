...
namespace SharedModels.ViewModels.Authentication
{
    ...
    //    }
    //    public UserVM(string id, string userName, string name)
    //    {
    //        this.Id = id;
    ...
    //    public static implicit operator UserVM(User entity)
    //        => new()
    //        {
    ...
    //        => new()
    //        {
    //            Id = !string.IsNullOrEmpty(entity.Id) ? entity.Id.ToString():null,
    //            UserName = entity.UserName,
    //            Name = entity.Name,
    //            Email = entity.Email,
    //            Role = entity.Role,
    ...
    //    public static implicit operator UserVM(ClaimsIdentity claimsIdentity)
    //        => new()
    //        {
